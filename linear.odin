...
// composed Linear sRGB <-> Linear P3 transforms
// product of XYZ <-> sRGB and XYZ <-> P3 matrices
...
when ENABLE_HDR {
	// composed Linear sRGB <-> Linear Rec2020 transforms
	// product of XYZ <-> sRGB and XYZ <-> Rec2020 matrices
	...
	// composed Linear P3 <-> Linear Rec2020 transforms
	// product of XYZ <-> P3 and XYZ <-> Rec2020 matrices
